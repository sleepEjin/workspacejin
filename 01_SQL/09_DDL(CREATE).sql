/*
    ...
    데이터베이스에서 사용하는 SQL 명령어 중 데이터를 저장할 객체의 구조를 정의하거나 변경하는 역할을 함.
    ...
    - 테이블 : 행과 열로 구성되는 가장 기본적인 데이터베이스 객체
        ...
        *자료형
        ...
        - 문자(CHAR(바이트크기) | VARCHAR2(바이트크기)) -> 반드시 크기를 지정해야 함
            ...
            -VARCHAR2 : 최대 4000 바이트까지 지정 가능/ 가변길이(몇 글자의 데이터가 들어올지를 확신할 수 없는 경우)
        -날짜(DATE)
...
INSERT INTO MEMBER
VALUES(1, 'USER01','PASS01',NULL, NULL,'010-1111-2222', NULL, NULL); -- 논리적으로 문제 발생
...
/*
    *UNIQUE 제약 조건
    ...
    컬럼값에 중복값을 제한하는 제약조건
    삽입/수정 시 기존에 있는 데이터값 중 중복값이 있을 경우 오타를 발생시킴
*/
...
CREATE TABLE MEMBER(
    MEM_NO NUMBER NOT NULL,
    MEM_ID VARCHAR2(30) CONSTRAINT MEM_ID_NN NOT NULL CONSTRAINT MEM_ID_UQ UNIQUE,
    MEM_PWD VARCHAR2(30) NOT NULL,
    MEM_NAME VARCHAR2(21) NOT NULL,
    GENDER CHAR(3),
    PHONE VARCHAR(13),
...
INSERT INTO MEMBER
VALUES(2, 'USER01','PASS01', '홍길순', NULL, NULL, NULL, NULL);
...
*/ 
 ...
 CREATE TABLE MEMBER (
    MEM_NO NUMBER CONSTRAINT MEMNO_NT NOT NULL,
    MEM_ID VARCHAR2(30) CONSTRAINT MEMID_NT NOT NULL,
    MEM_PWD VARCHAR2(30) CONSTRAINT MEMPWD_NT NOT NULL,
    MEM_NAME VARCHAR2(21) CONSTRAINT MEMNAME_NT NOT NULL,
 ...
 -- CHECK 제약 조건 때문에 '남', '여' 이외에 성별입력시 예외가 발생
...
INSERT INTO MEMBER
VALUES(1, 'USER01','PASS01', '홍길순', NULL, NULL, NULL, NULL);
-- 기본키에 중복된 값을 담으려고 할 때(UNIQUE제약조건 위반)   
INSERT INTO MEMBER
VALUES(1, 'USER01','PASS01', '홍길순', '남','010-1111-2222','aaa1@naver.com','25/07/30');
-- 기본키에 NULL 값을 담으려고 할 때 NOT NULL 위반

INSERT INTO MEMBER
VALUES(2, 'USER02','PASS02', '홍길삼', NULL, NULL, NULL, NULL);

INSERT INTO MEMBER
VALUES(3, 'USER03','PASS03', '홍길사', NULL, NULL, NULL, NULL);

INSERT INTO MEMBER
VALUES(4, 'USER04','PASS04', '홍길순', NULL, NULL, NULL, NULL);
...
/*
    ...
    -> 다른 테이블을 참조한다고 표현
    -> 대부분의 경우는 FROEIGN KEY를 통해서 테이블간의 관계가 활성화된다.
...
--유효하지 않은 회원등급번호는 정상적으로 INSERT 할 수 없음.
INSERT INTO MEM
VALUES(5, 'USER5', 'PASS5', '홍길오', NULL, NULL, NULL, '25/01/01', 50);
...
-------------------------------------------------------------
/*
    자식테이블 생성시 외래키 제약조건 부여할 때 삭제옵션을 함게 지정가능.
...
DELETE FROM MEM_GRADE
WHERE GRADE_CODE = 40;
--MEM_GRADE의 PK 40데이터가 삭제되면 SET NULL 옵션에 따라
...
--> 단, 해당 컬럼에 DEFAULT 값이 부여되어있다면 NULL이 아닌 DEFAULT 값이 적용됨
