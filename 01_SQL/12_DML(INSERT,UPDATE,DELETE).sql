/*
    ...
    DML(MANIPULATION 데이터 조작어) : INSERT, UPDATE, DELETE (실질적인 데이터)
    DDL(DEFINITION 데이터 정의어) : CREATE, ALTER, DROP (구조)
...
/*
    ...
    -> DEFAULT 값이 없고 NOT NULL제약조건이 걸려있는 컬럼은 반드시 직접 값을 넣어줘야한다.
*/
...
UPDATE EMP_SALARY
    SET SALARY = '7000000',
        BONUS = '0.2'
WHERE EMP_NAME = '선동일';
-- EMP_SALARY테이블에서 전체사원의 급여를 기존 급여의 10% 인상된 금액으로 변경
UPDATE EMP_SALARY
