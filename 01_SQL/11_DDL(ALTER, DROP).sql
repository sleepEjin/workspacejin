/*
    ...
    <ALTER>
    객체를 변경하는 명령어
    기존에 생성된 객체(테이블, 컬럼, 제약조건 등)의 객체 구조를 변경(수정,추가,제거,이름변경 등)을 할 때 사용
    
    ALTER 변경할 객체 변경할객체이름 변경할내용;
...
ALTER TABLE DEPT_COPY RENAME CONSTRAINT SYS_C008573 TO DEPT_ID_NN;
