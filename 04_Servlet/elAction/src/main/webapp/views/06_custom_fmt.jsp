...
<body>
	...
	<p>
		...
		(fmt:formatNumber value="출력할 값" 
			[
				groupingUsed="true|false" <!-- 전단위 구분자(,) 사용여부 -->
	...
	통화 : <fmt:formatNumber value="${num3}" type="currency" currencySymbol="KRW" /><br>
	...
	<ul>
		...
		<li>short : <fmt:formatDate value="${current}" type="both" dateStyle="medium" timeStyle="short" /></li>
		<li>full : <fmt:formatDate value="${current}" type="both" dateStyle="medium" timeStyle="full" /></li>
