...
public class Run {
	...
	public static void main(String[] args) {
		...
		ArrayList<Object> list = new ArrayList(); //크기를 지정하지 않아도 됨.
		
		System.out.println(list); //빈 배열상태
		
		//1. add(E e) : 리스트 공간 끝에 전달된 데이터 추가
		list.add(new Human("이무진",30));
		list.add(new String("이무진")); //여러 타입을 저장할 수 있음
		list.add(new Human("이진",25));
		list.add(new Human("이부진",20));
		
		System.out.println(list);
		
		//지정된 크기보다 더 많이 추가해도 에러가 발생하지 않음. 장점1 크기제약 X
		//다양한 타입의 데이터를 담을 수 있음. 장점2 여러 타입 보관 가능
