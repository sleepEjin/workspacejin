...
public class Input {
	...
	public static void main(String[] args) {
		...
		//.nextLine()
		//문자열 입력받는 함수(공백을 포함한 한줄, 개행문자 전까지)
		*/
		...
		sc.nextLine();  //nextInt()를 입력할 때 발생한 \n(엔터값)을 비워주는 코드
		
		System.out.printf("제 이름은 %s이며 %s에 살고 있습니다. 저는 올해 %d살입니다.",name, address, age);
		
		// 문자이외에 원시타입을 입력받을 때
		//.next타입()
		//nextInt(), nextDouble(), nexrBoolean() ...
		
		sc.close(); //Scanner 자원을 다쓰고 반납 *한번 반납하면 다시 사용X
		
		//sc = new Scanner(System.in); 에러가 발생
	}
